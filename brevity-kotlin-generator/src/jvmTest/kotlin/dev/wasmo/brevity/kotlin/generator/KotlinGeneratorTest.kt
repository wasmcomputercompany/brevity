...
class KotlinGeneratorTest {
  ...
  fun `full interface`() {
    ...
    assertThat(GuestGenerator(listOf(ktPackage)).generate(ktPackage).toString()).isEqualTo(
      """
      |// Generated by Brevity. Do not edit.
      |package wit.wasi.clocks.v0_2_12
      |
    ...
    assertThat(HostGenerator(listOf(ktPackage)).generate(ktPackage).toString()).isEqualTo(
      """
      |// Generated by Brevity. Do not edit.
  ...
  fun `full world`() {
    ...
    assertThat(HostGenerator(listOf(ktPackage)).generate(ktPackage).toString()).isEqualTo(
      ...
      |  val guest = CommandWorld.Guest(bridge)
      |  val host = hostFactory(guest)
      |  return CommandWorld(bridge, host, guest)
      |}
      |
      ...
      |
      |  public class Run(
      |    public val bridge: HostBridge,
      |  ) : wit.wasi.cli.v0_3_0.Run {
      |    public lateinit var store: Store
      |
      ...
      |    public lateinit var store: Store
      |
      |    override val run: Run = Run(bridge)
      |  }
      |}
      |
      """.trimMargin()
  ...
  fun `imports across packages`() {
    ...
    assertThat(HostGenerator(listOf(ktPackage)).generate(ktPackage).toString()).isEqualTo(
      ...
      |        ),
      |        WasmFunctionHandle { instance, args ->
      |          val self = this.host.monotonicClock
      |          val result = self.now(
      |          )
      |          error("TODO")
      |
  ...
  fun `imports of interfaces without functions are skipped`() {
    ...
    assertThat(HostGenerator(listOf(ktPackage)).generate(ktPackage).toString()).isEqualTo(
      ...
      |  val guest = Unit
      |  val host = hostFactory(guest)
      |  return ImportsWorld(bridge, host, guest)
      |}
      |
