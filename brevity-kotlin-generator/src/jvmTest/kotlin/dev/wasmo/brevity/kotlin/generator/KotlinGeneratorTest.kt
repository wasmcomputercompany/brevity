...
class KotlinGeneratorTest {
  ...
  fun `full interface`() {
    ...
    val irPackages = IrMapper(listOf(ioPackage)).map()
    val ktServices = KtMapper().map(irPackages)

    assertThat(ApiGenerator().generate(ktServices).single().toString()).isEqualTo(
      """
    ...
    assertThat(GuestGenerator().generate(ktServices).single().toString()).isEqualTo(
      """
      |// Generated by Brevity. Do not edit.
      |package wit.wasi.clocks.v0_2_12
      |
    ...
    assertThat(HostGenerator().generate(ktServices).single().toString()).isEqualTo(
      """
      |// Generated by Brevity. Do not edit.
      |package wit.wasi.clocks.v0_2_12
      |
  ...
  fun `world function`() {
    ...
    assertThat(GuestGenerator().generate(ktServices).single().toString()).isEqualTo(
      ...
      |
      |@WasmExport("run")
      |private fun guest_run(args: Int): Int {
  ...
  fun `imports across packages`() {
    ...
    assertThat(ApiGenerator().generate(ktServices).map { it.toString() }).containsExactly(
      """
      |// Generated by Brevity. Do not edit.
      |package wit.wasi.cli.v0_3_0
      |
    ...
    assertThat(GuestGenerator().generate(ktServices).map { it.toString() }).containsExactly(
      """
      |// Generated by Brevity. Do not edit.
      |package wit.wasi.cli.v0_3_0
      |
    ...
    assertThat(HostGenerator().generate(ktServices).map { it.toString() }).containsExactly(
      """
      |// Generated by Brevity. Do not edit.
      |package wit.wasi.cli.v0_3_0
      |
